...
public class RapportVisite {
    ...
    private String rap_avis;
    
    public RapportVisite(int rap_num, LocalDate rap_date_visite, LocalDate rap_date_saisie, String rap_bilan, Motif_visite motif, int rap_coeff_confiance, boolean rap_lu, Visiteur visiteur, Praticien praticien, String rap_avis){
    ...
    public String getRap_avis() {
        return rap_avis;
    }

    public void setRap_avis(String rap_avis) {
        this.rap_avis = rap_avis;
    }

    @Override
    public String toString() {
        return "RapportVisite{" + "rap_num=" + rap_num + ", rap_date_visite=" + rap_date_visite + ", rap_date_saisie=" + rap_date_saisie + ", rap_bilan=" + rap_bilan + ", motif=" + motif + ", rap_coeff_confiance=" + rap_coeff_confiance + ", rap_lu=" + rap_lu + ", visiteur=" + visiteur + ", praticien=" + praticien + ", rap_avis=" + rap_avis + '}';
    }  
