...
public class ModeleGsbRv {
    ...
    public static List<RapportVisite> getRapportsVisite(String matricule, int mois, int annee) throws ConnexionException, SQLException {
        ...
        String requete = "SELECT r.vis_matricule,rap_num, rap_date_visite, rap_bilan, rap_date_saisie, rap_coeff_confiance, rap_lu, pra_num, motif_libelle, rap_avis "
        ...
        try{
            ...
            if(resultat.next()){
                do{
                    ...
                    /*rappVis.setRap_avis(resultat.getString("rap_avis"));*/
    ...
    /*public static void setRapportVisiteAvis(String avis, String matricule, int numRapport) throws ConnexionException, SQLException{
        Connection connexion = ConnexionBD.getConnexion();
        ...
        try{
            PreparedStatement requetePreparee = (PreparedStatement) connexion.prepareStatement(requete);
            requetePreparee.setString(1, avis);
            requetePreparee.setString(2, matricule);
            requetePreparee.setInt(3, numRapport);
